...
void LunarCalendarWidget::initWidget()
{
    ...
    widgetTop->setMinimumHeight(40);

    //上一年按钮
    QToolButton *btnPrevYear = new QToolButton;
    btnPrevYear->setObjectName("btnPrevYear");
    btnPrevYear->setText("上年");
    btnPrevYear->setAutoRaise(true);
    ...
    btnNextYear->setText("下年");
    btnNextYear->setAutoRaise(true);

    //上个月按钮
    QToolButton *btnPrevMonth = new QToolButton;
    btnPrevMonth->setObjectName("btnPrevMonth");
    btnPrevMonth->setText("上月");
    btnPrevMonth->setAutoRaise(true);
    ...
    btnNextMonth->setText("下月");
    btnNextMonth->setAutoRaise(true);
